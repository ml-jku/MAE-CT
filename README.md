...
[[Project Page](https://ml-jku.github.io/MAE-CT)] [[arXiv](https://arxiv.org/abs/2304.10520)] [[Models](https://github.com/ml-jku/MAE-CT#pretrained-checkpoints)] [[BibTeX](https://github.com/ml-jku/MAE-CT#citation)] [[Follow-up work (MIM-Refiner)](https://ml-jku.github.io/MIM-Refiner/)]
...
- Models can be trained using the hyperparameters provided [here](https://github.com/ml-jku/MAE-CT/yamls). 
  Examples how to start training runs can be found [here](https://github.com/ml-jku/MAE-CT#train-models).
- We provide instructions for reproducing our probing result in 
  [PROBING.md](https://github.com/ml-jku/MAE-CT/blob/main/PROBING.md).
