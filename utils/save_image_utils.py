...
def greyscale_to_viridis(tensor) -> Image:
    assert tensor.ndim == 3 and tensor.size(0) == 1
...
def save_image_tensors(tensors, out_uri, denormalize=None, scale_range_per_image=False, scale_factor=1., padding=2):
    ...
    save_images(images, out_uri, scale_factor, padding)
