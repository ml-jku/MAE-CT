...
class StageSummarizerBase:
    ...
    def __init__(self, stage_path_provider: StagePathProvider, summary_provider: SummaryProviderBase):
    ...
    def all_log_entries(self):
        if StageSummarizerBase.__all_log_entries is None:
            with open(self.stage_path_provider.primitive_output_path / "entries.yaml") as f:
